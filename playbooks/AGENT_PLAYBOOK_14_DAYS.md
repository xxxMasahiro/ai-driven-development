...
このファイルは、`STEP 1-14: 実践レッスン` を進めるエージェント向けの台本です。
`STEP 1-7: 基礎レッスン` のプレイブックは変更せず、拡張コースとして使います。
...
MCP関連の作業は、連携先、入力、出力、最小範囲、便利になる点、実装前の依頼文、確認方法を説明してから承認を取る
```

## 完了判定

```text
Step 14/14の最終同期が完了している
main CIが成功している
ローカルとリモートが同期している
