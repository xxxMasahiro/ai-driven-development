...
require_pattern "skills/task-tracker-docs/SKILL.md" 'REQUIREMENTS\.md' "requirements route"
require_pattern "skills/task-tracker-docs/SKILL.md" 'TASK_TRACKER\.md' "tracker route"
require_pattern "skills/task-tracker-docs/SKILL.md" 'separate Ubuntu/WSL CLI window' "task docs product CLI prompt"
require_pattern "skills/worklog-doc-sync/SKILL.md" 'IMPLEMENTATION_PLAN\.md' "implementation plan route"
...
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 3.*check_repository_boundary\.sh --product-required && tools/check_git_sync\.sh --product --clean-required' "Day 3 product boundary gate"
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 5.*check_git_sync\.sh --product --required && tools/check_ci_status\.sh --product --required' "Day 5 product git ci gate"
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 11.*check_git_sync\.sh --product --required && tools/check_ci_status\.sh --product --required' "Day 11 product git ci gate"
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 13.*check_agents_skills\.sh' "Day 13 agents skills gate"
require_pattern "lesson/SYNC_GATES_14_DAYS.tsv" 'Day 14.*check_git_sync\.sh --product --required && tools/check_ci_status\.sh --product --required' "Day 14 product git ci gate"
