...
```text
Step 4/14として、REQUIREMENTS.md、SPECIFICATION.md、IMPLEMENTATION_PLAN.mdの初期案を作ります。
...
```text
Step 5/14として、3文書の初回作成をTASK_TRACKER.mdとHANDOFF.mdへ記録し、
...
```text
Step 8/14として、HANDOFF.mdを使って中断と再開を体験します。
...
```text
Step 14/14として、REQUIREMENTS.md、SPECIFICATION.md、IMPLEMENTATION_PLAN.md、
...
```text
教材そのものを改善したいです。
DEVELOPER_MEMORY.md、TASK_TRACKER.md、HANDOFF.md、REQUIREMENTS.md、SPECIFICATION.md、IMPLEMENTATION_PLAN.mdを確認し、開発者メモリの改善点と問題点をすべて満たすように教材側だけを安全に実装・同期してください。
