...
このファイルは、STEP 1-14: 実践レッスンの学習ロードマップです。
学習者が現在地を見失わないように、各STEPの目的、主な成果、同期ゲートをまとめます。

## STEP 1-14の目的

```text
AI駆動開発の本質を、小さなタスク管理表を作りながら体験する。
開発者が目的を与え、エージェントとの壁打ちで要件、仕様、実装計画、検証方法を引き出す技術を学ぶ。
作業履歴、引き継ぎ、Git、GitHub、CI、E2E、レビュー、サブエージェント、スキル、MCPを、ばらばらではなく一連の開発ワークフローとして理解する。
```
...
未来のSTEPへのスキップは禁止する。
完了済みのSTEPは復習として自由に戻れる。
```

## ロードマップ

| Step | テーマ | 体験すること | 同期ゲート |
| --- | --- | --- | --- |
| Step 1/14 | 全体像と学習制御 | index-14-days.md、STEP 1-14ロードマップ、教材/成果物リポジトリ境界 | 学習記録と現在地 |
